...
$(document).ready(function () {
	...
	// Countdown //
	$('#countdown').countdown({
		until: new Date(2014, 5 - 1, 31), // new Date(year, mth - 1, day, hr, min, sec) - date/time to count down to
	...
	// Google Map //
	$('#map_canvas').gmap({
		'center': new google.maps.LatLng(41.414502,  2.177482), // Change this to your desired latitude and longitude
		'zoom': 17,
	...
	$('#map_canvas').gmap().bind('init', function () {
		$('#map_canvas').gmap('addMarker', {
			'id': 'marker-1',
			'position': '41.413702,2.177482',
			'bounds': false,
			'icon': image
		}).click(function () {
			$('#map_canvas').gmap('openInfoWindow', {
				'content': '<h4>deSymfonyDay2014</h4><p><strong>Casa Convalescència</strong><br/>C/ Sant Antoni Maria Claret 171<br/>08041 Barcelona</p>'
			}, this);
		});
	});
